...
model Alegams_globals
 global{
	...
	//float HH_2ndincome_avg_INT <- 44.2/12 parameter: "average sec. income intensive Vannamei (mVnd/month)" category: "Farm" ;
	//float HH_2ndincome_stddev_INT <- 15.00/12;
	...
	float HH_2ndincome_stddev_IMS <- 2.00/12 ;
	...
	//cost to seed new shrimp pond (mVnd/ha)
 	float shrimp_init_INT <- 100 parameter: "cost to seed new intensive (mVnd/ha)" category: "Crop" ; //250
 	float shrimp_init_IE <- 50.00 parameter: "cost to seed new improved extensive(mVnd/ha)" category: "Crop" ; //85
 	float shrimp_init_IMS <- 30.00 parameter: "cost to seed new integrated mangrove(mVnd/ha)" category: "Crop" ; //79	 
	...
	// maintance cost
 	...
 	float mantain_cost_IE <- 13.0 parameter: "mantain crop cost improve extensive (mVnd/ha/cycle)" category: "Crop" ;
 	...
 	float Cost_1st_month_INT_vana <- 220.0 parameter: "1st crop cost intensive  Vanamei (mVnd/ha)" category: "Crop" ;
 	...
 	float Nomal_cost_INT_vana <- 160.0 parameter: "monthly crop cost intensive Vanamei (mVnd/ha/month)" category: "Crop" ;
	...
	float shrimp_price_INT_vana <- 0.12 parameter: "shrimp price intensive Vannamei (mVnd/kg)" category: "Market" ; //0.12
